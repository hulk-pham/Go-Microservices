...
import (
	...
	"errors"
	"fmt"
	"hulk/go-webservice/graph/model"
	"strconv"
	"sync"
	"sync/atomic"
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "User.hobby":
		if e.complexity.User.Hobby == nil {
			break
		}

		return e.complexity.User.Hobby(childComplexity), true
...
func (ec *executionContext) fieldContext_Mutation_createUser(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "hobby":
				return ec.fieldContext_User_hobby(ctx, field)
			case "phone_number":
...
func (ec *executionContext) _User_hobby(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_User_hobby(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_User_hobby(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "User",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) unmarshalInputCreateUserRequest(ctx context.Context, obj interface{}) (model.CreateUserRequest, error) {
	...
	fieldsInOrder := [...]string{"first_name", "last_name", "email", "password", "hobby", "phone_number", "address", "dob", "avatar"}
	for _, k := range fieldsInOrder {
		...
		case "hobby":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("hobby"))
			it.Hobby, err = ec.unmarshalNString2string(ctx, v)
			if err != nil {
				return it, err
			}
		case "phone_number":
...
func (ec *executionContext) _User(ctx context.Context, sel ast.SelectionSet, obj *model.User) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "hobby":
			...
			out.Values[i] = ec._User_hobby(ctx, field, obj)
